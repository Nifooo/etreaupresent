...
<div class="switch-button"><span class="active"></span>
        <button class="switch-button-case left active-case">Massage</button>
        <button class="switch-button-case right">Hypnose</button></div>
...
<div id="page2">
    <div class="container">
        <img src="asset/img/massage2.jpg" alt="Massage" style="width:100%;">
